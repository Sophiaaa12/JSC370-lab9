...
_fun1(100) is about 7 times faster than fun1alt(100) by comparing with mean of them._
...
- The first boxplot shows that fun2(x) has higher execution times with higher outliers, while fun2alt(x) exhibits lowerexecution times with lower outliers. The second violin plot confirms that fun2alt(x) not only has a lower median but also a much more concentrated density, which is better.
...
_ncpus = 8L is slightly faster than ncpus = 1L_
